...
const VideoPasswordReset = () => {
  ...
  useEffect(() => {
    ...
    else if (localStorage.getItem("authToken2")) navigate("/");
  }, [navigate]);
  ...
  const handleSubmit = async () => {
    ...
    const password = generatePassword(captures);
      ...
      <Container>
        <Box>
          ...
          <ContentWrapper>
            ...
            <Subtitle>Select frames to create your password</Subtitle>
